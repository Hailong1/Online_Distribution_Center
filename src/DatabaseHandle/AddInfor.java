...
public class AddInfor extends HttpServlet{
	...
	/**
	 * add the new information successful.
	 */
	public void doGet(HttpServletRequest request,HttpServletResponse response)
	{
		...
		try {
			...
			out.println("<font size='8' color='red'>add new accounts successfully</font>");
	...
	/**
	 * add the new information when in the employee.
	 */
    ...
    try {
            ...
            print.pl("resultRegion:"+resultexist2);
   		    ...
   		    if(!resultpass)
   		    {
   		    	request.getRequestDispatcher("AddNewRoleP.jsp").forward(request,response);
   		    }
   		    else if(resultexist=="true"||resultexist1=="true"||user.isEmpty())
   		    {
   		    	request.getRequestDispatcher("AddNewRoleE.jsp").forward(request,response);
   		    }

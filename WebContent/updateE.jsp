...
/*if(judge.equals("true"))
{
  ...
  String select="select * from employee where employee_username='"+name+"';";
  ArrayList<String> list=new ArrayList<String>(); 
  list=hd.getWholeOneListValue(select,9);
  String []mail=list.get(7).split("@");
  String Fmail=mail[0];
  String Lmail=mail[1];
...
<body><center>
    ...
    <div id="all">
    <div id="title">update employee</div><br/>
    <form id="fom" action="einfor" method="POST">
       <table id="ta">
           <tr id="tr4">
           ...
           <tr id="tr7">
               ...
               <td id="td7.2"><input type="text" id="in7" value="<%=list.get(6)%>" name="5"></td>
           </tr>
            <tr id="tr8">
         ...
         <table>
         <p id="p">
         <input type="hidden" name="8" value="<%=request.getAttribute("Employeename") %>">

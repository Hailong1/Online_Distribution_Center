...
<body><center>
    ...
    <form id="fom" action="Regist" method="POST">
       <table id="ta">
           <tr id="tr1">
           ...
           <tr id="tr7">
            ...
            <tr id="tr9">
             ...
             <tr id="tr11">
               ...
               <td id="td11.2"><input type="text" id="in22" name="22"></td>
           </tr>
             <tr id="tr9">
         ...
         <input type="reset" value="reset" style="font-size:20px;">
             <input type="button" value="register" style="font-size:20px;" onclick="register()" >
        </form> 
     </center>   
    </p>
    <div id="d">password should have at least one underline _ character and one Uppercase and one number</div>
